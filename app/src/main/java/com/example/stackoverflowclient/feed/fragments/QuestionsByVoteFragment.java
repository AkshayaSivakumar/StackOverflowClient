...
public class QuestionsByVoteFragment extends Fragment {
    ...
    private void handleRecyclerView() {
        ...
        ItemViewModel itemViewModel = ViewModelProviders.of(this, new CustomViewModelFactory(apiService, accessToken, BaseConstants.QUESTIONS_BY_VOTES_API_SERVICE, BaseConstants.SORT_BY_VOTES)).get(ItemViewModel.class);
