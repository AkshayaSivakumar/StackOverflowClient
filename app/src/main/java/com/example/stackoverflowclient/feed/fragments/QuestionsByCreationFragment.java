...
public class QuestionsByCreationFragment extends Fragment {
    ...
    @BindView(R.id.creation_recycler_view)
    ...
    private void handleRecyclerView() {
        ...
        ItemViewModel itemViewModel = ViewModelProviders.of(this, new CustomViewModelFactory(apiService, accessToken, BaseConstants.QUESTIONS_BY_CREATION_API_SERVICE, BaseConstants.SORT_BY_CREATION)).get(ItemViewModel.class);
